import { getReportes, getReporteById, updateReporteStatus, deleteReporte } from "../services/serviceReportes.js";
...
async function mostrarReportes() {
    ...
    document.querySelectorAll(".btn-eliminar").forEach(btn => {
        ...
        btn.addEventListener("click", function () {
            eliminarReporte(btn.dataset.id)
        });
    });
}
